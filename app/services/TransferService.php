        ...
        try {
            ...
            if (
                ...
                throw new SystemException(
                    "All fields are required for transfer",
                );
            }
            ...
            if (
                ...
                throw new SystemException(
                    "Invalid product_id, from_warehouse, to_warehouse or user_id",
                );
            }
            ...
            if ($result->num_rows === 0) {
                throw new SystemException(
                    "Invalid user_id: No such user found",
                );
            }
            ...
            if ($result->num_rows === 0) {
                throw new SystemException(
                    "Invalid product_id: No such product found",
                );
            }
            ...
            if ($result->num_rows < 2) {
                throw new SystemException(
                    "Invalid warehouse IDs: One or both warehouses not found",
                );
            }
            ...
            if ($from_warehouse === $to_warehouse) {
                throw new ValidationException(
                    "From and To warehouses cannot be the same for a transfer",
                );
            }
            ...
            if ($quantity <= 0) {
                throw new ValidationException(
                    "Quantity must be greater than zero for a transfer",
                );
            }
            ...
            if ($result->num_rows === 0) {
                throw new ValidationException(
                    "No stock found for product in from_warehouse",
                );
            } else {
                ...
                if ($snapshot["quantity"] < $quantity) {
                    throw new ValidationException(
                        "Insufficient stock in from_warehouse for transfer. Available: " .
                            $snapshot["quantity"],
                    );
                }
            }
            ...
            $updated_from_warehouse_stock =
                $current_from_warehouse_stock - $quantity;
            ...
            # Calculate resulting stock
            $updated_to_warehouse_stock =
                $current_to_warehouse_stock + $quantity;
